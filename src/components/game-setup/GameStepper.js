...
import Customize from './stepper-components/Customize';
import GameType from './stepper-components/GameType';
...
export default function HorizontalNonLinearStepper() {
  ...
  const handleStep = (step) => () => {
    ...
    // Inform user they must complete step to continue - toast
  };
  ...
  // add catch here to double check reset
  const handleReset = () => {
    setActiveStep(0);
    setCompleted({});
  };
